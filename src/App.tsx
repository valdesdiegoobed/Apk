...
import {
  AppBar, Box, Container, CssBaseline, Divider, Drawer, IconButton,
  ...
  return <>
    ...
    <AppBar position="sticky" color="primary" elevation={1}>
      <Toolbar>
        ...
        <Typography variant="h6" sx={{ flexGrow: 1, fontWeight: 750 }}>Nuevo Proyecto Android</Typography>
        <Typography variant="caption" sx={{ display: { xs: 'none', sm: 'block' } }}>Migración DV Control</Typography>
      </Toolbar>
    </AppBar>
    <Drawer open={drawerOpen} onClose={() => setDrawerOpen(false)}>
      <Box sx={{ width: 300 }} role="navigation">
        <Box sx={{ px: 2.5, py: 2.25 }}><Typography variant="h6" fontWeight={800}>Nuevo Proyecto Android</Typography><Typography variant="body2" color="text.secondary">Menú principal</Typography></Box>
        <Divider />
    ...
    <Box component="main" sx={{ py: 3, minHeight: 'calc(100vh - 64px)' }}><Container maxWidth="lg"><Outlet /></Container></Box>
  </>;
}
